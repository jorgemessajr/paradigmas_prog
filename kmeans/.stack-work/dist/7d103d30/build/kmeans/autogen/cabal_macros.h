...
/* package kmeans-0.1.0.0 */
#ifndef VERSION_kmeans
#define VERSION_kmeans "0.1.0.0"
#endif /* VERSION_kmeans */
#ifndef MIN_VERSION_kmeans
#define MIN_VERSION_kmeans(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_kmeans */
...
#define CURRENT_COMPONENT_ID "kmeans-0.1.0.0-5juOnZ2IbgzFQmOLALV6WB-kmeans"
